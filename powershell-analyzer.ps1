...
.DESCRIPTION
    This script installs PSScriptAnalyzer if missing, scans all PowerShell scripts and module definition files,
    and exits with code 1 if any violations are found. Intended for CI/CD pipelines or local validation.
#>
